...
function __construct($FinestrinoScuro,$sportelloApertoInAlto)
{

$this -> sportello = $sportelloApertoInAlto;
$this -> finestrino = $FinestrinoScuro;
...
$macchina = new lambo("finestrinoscuro", "sportelloapertoinalto");
echo $macchina -> sportello;    
